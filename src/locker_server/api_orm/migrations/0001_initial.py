...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PMUserPlanORM',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='pm_user_plan', serialize=False, to='api_orm.userorm')),
        ...
        migrations.CreateModel(
            name='Policy2FAORM',
            fields=[
                ('policy', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='policy_2fa', serialize=False, to='api_orm.enterprisepolicyorm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('policy', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='policy_failed_login', serialize=False, to='api_orm.enterprisepolicyorm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('policy', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='policy_master_password_requirement', serialize=False, to='api_orm.enterprisepolicyorm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('policy', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='policy_passwordless', serialize=False, to='api_orm.enterprisepolicyorm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('policy', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='policy_password_requirement', serialize=False, to='api_orm.enterprisepolicyorm')),
                ('min_length', models.IntegerField(default=None, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(128)])),
                ('require_lower_case', models.BooleanField(default=False)),
                ('require_upper_case', models.BooleanField(default=False)),
                ('require_special_character', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            name='UserScoreORM',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='user_score', serialize=False, to='api_orm.userorm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_devices', to=settings.LS_USER_MODEL)),
            ],
            options={
                'db_table': 'cs_devices',
                'abstract': False,
