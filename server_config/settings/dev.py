...
try:
    ...
    SLACK_SAAS_LICENSE_LOG = os.getenv("SLACK_SAAS_LICENSE_LOG")
    ...
    if R2_BUCKET:
        DEFAULT_CLOUD_STORAGE = "r2"
    else:
        DEFAULT_CLOUD_STORAGE = "aws"
    ...
    PAYMENT_CLICK_NAME = os.getenv("PAYMENT_CLICK_NAME", "click_uuid")
    PAYMENT_CLICK_URL = os.getenv("PAYMENT_CLICK_URL")
    PAYMENT_CLICK_API_KEY = os.getenv("PAYMENT_CLICK_API_KEY")
