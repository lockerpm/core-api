...
LS_ENTERPRISE_AVATAR_MODEL = getattr(settings, "LS_ENTERPRISE_AVATAR_MODEL", "api_orm.EnterpriseAvatarORM")
...
DEFAULTS = {
    ...
    "LS_ENTERPRISE_AVATAR_MODEL": LS_ENTERPRISE_AVATAR_MODEL,
