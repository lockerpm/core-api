...
urlpatterns += [
    ...
    url(r'^resources/cystack_platform/pm/autofill_keys$',
        views.ResourcePwdViewSet.as_view({'get': 'list_autofill_key'})),
    url(r'^resources/cystack_platform/pm/autofill_keys/(?P<key>[0-9a-z-A-Z-_]+)$',
