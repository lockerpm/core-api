...
urlpatterns += [
    ...
    url(r'^users/me/block_policy$', views.UserPwdViewSet.as_view({'get': 'block_policy_me'})),
    ...
    url(r'^users/access_token$', views.UserPwdViewSet.as_view({'post': 'access_token'})),
...
urlpatterns += [
    ...
    url(r'^admin/payments/statistic/net$', views.PaymentPwdViewSet.as_view({'get': 'statistic_net'})),
