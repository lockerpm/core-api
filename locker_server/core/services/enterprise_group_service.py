...
class EnterpriseGroupService:
    ...
    def list_enterprise_groups(self, **filters) -> List[EnterpriseGroup]:
        return self.enterprise_group_repository.list_enterprise_groups(
            **filters
        )
    ...
    def delete_group_by_id(self, enterprise_group_id: str) -> NoReturn:
        self.enterprise_group_repository.delete_enterprise_group_by_id(
            enterprise_group_id=enterprise_group_id
        )
    ...
    def update_members(self, enterprise_group: EnterpriseGroup, enterprise_member_ids: List[str]) -> List[str]:
        ...
        existed_group_enterprise_member_ids = [
            group_member.member.enterprise_member_id
        ...
        deleted = self.enterprise_group_member_repository.delete_multiple_by_member_ids(
