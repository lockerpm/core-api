...
class ReleaseService:
    ...
    def generate_next_release(self, client_id: str, environment: str, platform: str = None) -> Optional[Release]:
        latest_release = self.get_latest_release(client_id=client_id, environment=environment, platform=platform)
    ...
    def create_next_release(self, client_id: str, environment: str, checksum: list = None,
                            platform: str = None) -> Optional[Release]:
